            ...
            <div className="container-fluid position-relative px-5">
                <div className="row bg-blue position-relative text-center ">
                    <div className="col-xl-12 pt-5">
                        <h3 className='fw-bold fs-1 size-about'>La Red de Compras de Mayor crecimiento en los últimos años.</h3>
                ...
                <div className="row services-row position-relative justify-content-center rounded-container mb-5 m-5">
                    <div className="col-xl-5 col-md-12 bg-arg rounded-5 size-about shadow mb-2" style={{ width: '32%', height: '50vh' }} >
                        <h4 className='text-overlay'>Quienes somos?</h4>
                    </div>
                    <div className="col-xl-7 col-md-12 p-5 rounded-container rounded-5 bg-light shadow mb-2" >
                ...
                <div className="row services-row position-relative justify-content-center rounded-container m-5">
                    <div className="col-xl-5 bg-mision rounded-5 size-about shadow mb-2" style={{ width: '32%', height: '50vh' }} >
                        <h4 className='text-overlay'>Nuestra Mision</h4>
                    </div>
                    <div className="col-xl-7 p-5 shadow rounded-5 mb-2">
